...
The marketplace repository contains plugins that can be installed locally in AI agent application to automate various tasks in your running IntelliCAD. Each plugin has its own README.md file.
