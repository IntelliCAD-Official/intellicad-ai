...
description: >-
  Interactive expert assistant skill for querying IntelliCAD documentation
  through the MCP server. This skill provides expert-level guidance on
  IntelliCAD functions, commands, usage.
